...
$chart_id = isset( $attributes['chartId'] ) ? esc_html( $attributes['chartId'] ) : 'ifused_chart_donutchart';
...
<p>
	<?php esc_html_e( 'Our donut chart output', 'ifused-charts' ); ?>
</p>
...
<!--
    ...
    <?php endif; ?>
	-->
	<div class="wp-block-ifused-donut-chart-block" data-set1Bgcolor="<?php echo $attributes['datasetBgColor'];?>" data-pointslabel1="<?php echo $attributes['datasetLabel'] ;?>"  data-chart-title="<?php echo $chart_title;?>" data-points='<?php echo esc_attr( json_encode( $points ) ); ?>'>
		<canvas id="<?php echo $chart_id;?>" class="ifused_donutchart"></canvas>
	</div>
</div>
